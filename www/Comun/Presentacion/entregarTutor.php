...
<div class="hueco"></div>
<div class="row">
	<h4 class="col-md-7 col-md-offset-2 col-xs-12">Sección de evaluación del tutor</h4>
</div>
<div class="hueco"></div>
...
<div class="row">
	...
	<div class="col-md-6 col-xs-9">
		<textarea class="form-control" id="inputValoracion<?=$dniA;?>" rows="8" placeholder="Escriba la valoración acerca del trabajo realizado por el alumno" required></textarea>
	</div>
</div>
<div class="row">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>¿Desea realmente guardar la valoración de los alumnos para presentar al tribunal?</p>
            </div>
